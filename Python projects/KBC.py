print("It is a really tough game if you gave every answer without failing you will won \"7crores\"\n")
...
def asking( q):
    ...
    while(answer== ans[q]):
        ...
        # elif(answer!=ans[q]):
    if(answer!=ans[q]):    
        print("your answer is incurrect\n So, you are going to your home with",prize[q-1])

    elif(answer==ans(15)):
        print("Congratulations",name, "you won the highest amount of \"7 crores\"")    
